...
class Cluster {
    ...
    constructor(name: string, code: string, commands: Command[]) {
        this.name = name;
        this.code = code;
...
export default class Clusters {
    static clusters: Cluster[] = [
        ...
        new Cluster(
            ClusterName.BUTTON, '06',
            [
                new Command(CommandButton.BP_STATUS, '00')
            ]
        ),
        new Cluster(
            ClusterName.SOUND, '07',
            [
    ...
    static getClusterByNameOrCode(identifier: string, isCode = false): Cluster {
    ...
    static getClusterByName(clusterName: string): Cluster {
    ...
    static getClusterByCode(clusterCode: string): Cluster {
    ...
    static getCommandByName(cluster: Cluster, commandName: string): Command {
    ...
    static getCommandByCode(cluster: Cluster, commandCode: string): Command {
        const commands = Clusters.getClusterByNameOrCode(cluster.name).commands;
