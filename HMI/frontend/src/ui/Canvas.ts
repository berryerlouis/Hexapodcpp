...
import SceneLoader from "./Loader.js";
...
export default class Canvas {
    ...
    controls: any;
    groupBody: THREE.Group<THREE.Object3DEventMap>;
    raycasting: any;
    robot: any;
    ...
    async load() {
        ...
        sceneLoader.loadModel('assets/scene.gltf')
            .then((robot) => {
                this.robot = robot;
                //remove pcb from scene
                this.robot.scene.children[0].children[0].children[0].children[0].children =
                    this.robot.scene.children[0].children[0].children[0].children[0].children.filter((obj: any) => obj.name !== "PCB_v21");
