...
export default function drawBody(name: string, heightOffset: number): THREE.Group {
    ...
    geometry = new THREE.BoxGeometry(2 * hexapod.body.width / 3, hexapod.body.thickness, hexapod.body.height / 1.5);
