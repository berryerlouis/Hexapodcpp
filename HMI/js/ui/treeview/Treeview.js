import { Clusters, ClusterName, CommandGeneral } from '../../protocol/Cluster.js'
...
export class Treeview {
    ...
    addCommandListToTreeview(clusterName, commands) {
        ...
        for (let index = 0; index < commands.length - 1; index++) {
            ...
            itemCommand.className = "list-group-item";
            ...
            itemCommandUpdateButton.className = "btn btn-secondary ms-3 "
