...
export default class Command {
    constructor(communication) {
        ...
        this.positionX[0].onchange = (() => {
            this.updateBody();
        })
        this.positionY[0].onchange = (() => {
            this.updateBody();
        })
        this.positionZ[0].onchange = (() => {
            this.updateBody();
        })
        this.rotationX = $('#body-rotation-x');
        this.rotationY = $('#body-rotation-y');
        this.rotationZ = $('#body-rotation-z');
        this.rotationX[0].onchange = (() => {
            this.updateBody();
        })
        this.rotationY[0].onchange = (() => {
            this.updateBody();
        })
        this.rotationZ[0].onchange = (() => {
            this.updateBody();
        })
        ...
        this.servoAngle[0].onchange = (() => {
            this.updateServoAngle();
        })
        this.servoOffset = $('#servo-offset');
        this.servoOffset[0].onchange = (() => {
            this.updateServoOffset();
        })
    ...
    updateBody() {
        ...
        let msg = new Message().build(Cluters.ClusterName.BODY, Cluters.CommandBody.SET_BODY_X_Y_Z, 14, [
