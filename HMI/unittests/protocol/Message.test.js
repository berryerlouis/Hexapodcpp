...
describe('Message', () => {
    ...
    test('should build message correctly', () => {
        message.build(ClusterName.GENERAL, CommandGeneral.VERSION);
    ...
    test('should build message with params correctly', () => {
        message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 4, ['01', '02', '03', '04']);
        expect(message.cluster.name).toBe('GENERAL');
        expect(message.cluster.code).toBe('00');
        expect(message.command.name).toBe('VERSION');
        expect(message.command.code).toBe('00');
    ...
    test('should not build message with wrong command name', () => {
        const throwedBuild = () => {
            message.build(ClusterName.GENERAL, "COMMAND_WRONG");
        };
    ...
    test('should not build message with wrong size', () => {
        const throwedBuild = () => {
            message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 1, ['01', '02', '03', '04']);
        };
    ...
    test('should not build message with no size set', () => {
        const throwedBuild = () => {
            message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 0, ['01', '02', '03', '04']);
        };
        expect(throwedBuild).toThrow(MessageSizeError);
    });
    ...
    test('should not build message with null param', () => {
        const throwedBuild = () => {
            message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 4, null);
        };
        expect(throwedBuild).toThrow(MessageSizeError);
    });
    ...
    test('should fetchInt8U correctly', () => {
        message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 5, ['01', '02', '03', '04', 'FF']);
    ...
    test('should fetchInt8S correctly', () => {
        message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 4, ['81', '02', '03', '04']);
    ...
    test('should fetchInt16S correctly', () => {
        message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 4, ['2F', 'E9', '03', '04']);
    ...
    test('should fetchInt32S correctly', () => {
        message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 4, ['EB', 'DC', 'A6', 'FF']);
        expect(message.fetchInt32S()).toBe(-5841685);
    });

    test('should fetchInt64U correctly', () => {
        message.build(ClusterName.GENERAL, CommandGeneral.VERSION, 8, ['01', '02', '03', '04', '05', '06', '07', '08']);
