        ...
        namespace Ultrasound
        {
            ...
            protected:
                ...
                SetUp() {
                    ...
                    EXPECT_CALL(mMockInputCapture, Initialize()).Times(1U).WillOnce(Return(Core::Status::CORE_OK));
                    EXPECT_CALL(mMockLed, Initialize()).Times(1U).WillOnce(Return(Core::Status::CORE_OK));
