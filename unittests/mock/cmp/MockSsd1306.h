...
namespace Component
{
    namespace Display
    {
        ...
        public:
            ...
            MOCK_METHOD3(DrawPixel,
                         void(uint16_t x, uint16_t y, uint16_t color));
            ...
            MOCK_METHOD4(
                    DrawCircle,
                    void(uint16_t xc, uint16_t yc, uint16_t r, uint16_t color));
