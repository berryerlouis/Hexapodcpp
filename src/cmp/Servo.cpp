...
Servo::Servo(Pca9685 &pca9685, const uint8_t servoId)
    : mPca9685(pca9685), mServoId(servoId), mAngle(90), mTargetAngle(0), mStartTime(0), mSpeed(1), mOffset(0), mMin(SERVO_ANGLE_MIN), mMax(SERVO_ANGLE_MAX), mReverse(false), mEnable(true), mIsMoving(false)
{
}
Servo::Servo(Pca9685 &pca9685, const uint8_t servoId, const uint8_t angle)
    : mPca9685(pca9685), mServoId(servoId), mAngle(angle), mTargetAngle(0), mStartTime(0), mSpeed(1), mOffset(0), mMin(SERVO_ANGLE_MIN), mMax(SERVO_ANGLE_MAX), mReverse(false), mEnable(true), mIsMoving(false)
{
}
Servo::Servo(Pca9685 &pca9685, const uint8_t servoId, const uint8_t angle, const int8_t offset)
    : mPca9685(pca9685), mServoId(servoId), mAngle(angle), mTargetAngle(0), mStartTime(0), mSpeed(1), mOffset(offset), mMin(SERVO_ANGLE_MIN), mMax(SERVO_ANGLE_MAX), mReverse(false), mEnable(true), mIsMoving(false)
{
}
Servo::Servo(Pca9685 &pca9685, const uint8_t servoId, const uint8_t angle, const int8_t offset, const uint8_t min, const uint8_t max)
    : mPca9685(pca9685), mServoId(servoId), mAngle(angle), mTargetAngle(0), mStartTime(0), mSpeed(1), mOffset(offset), mMin(min), mMax(max), mReverse(false), mEnable(true), mIsMoving(false)
{
}
Servo::Servo(Pca9685 &pca9685, const uint8_t servoId, const uint8_t angle, const int8_t offset, const uint8_t min, const uint8_t max, const bool reverse)
    : mPca9685(pca9685), mServoId(servoId), mAngle(angle), mTargetAngle(0), mStartTime(0), mSpeed(1), mOffset(offset), mMin(min), mMax(max), mReverse(reverse), mEnable(true), mIsMoving(false)
{
}
