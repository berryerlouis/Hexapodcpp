...
namespace Misc
{
    namespace Utils
    {
        ...
        LerpPosition(const Maths::Position3d a, const Maths::Position3d b, const float t) {
            return {Lerp<float>(a.x, b.x, t), Lerp<float>(a.y, b.y, t), Lerp<float>(a.z, b.z, t)};
        }
        ...
        static inline Maths::Position3d bezierQuadratic(const Maths::Position3d &p0,
...
#define UINT32_TO_ARRAY(val)                                                       \
    {                                                                              \
        static_cast<uint8_t>(val & 0xFFU), static_cast<uint8_t>(val >> 8U),        \
                static_cast<uint8_t>(val >> 16U), static_cast<uint8_t>(val >> 24U) \
    }
...
#define UINT48_TO_ARRAY(val)                                                        \
    {                                                                               \
        static_cast<uint8_t>(val & 0xFFU), static_cast<uint8_t>(val >> 8U),         \
                static_cast<uint8_t>(val >> 16U), static_cast<uint8_t>(val >> 24U), \
                static_cast<uint8_t>(val >> 32U), static_cast<uint8_t>(val >> 40U)  \
    }
...
#define UINT64_TO_ARRAY(val)                                                        \
    {                                                                               \
        static_cast<uint8_t>(val & 0xFFU), static_cast<uint8_t>(val >> 8U),         \
                static_cast<uint8_t>(val >> 16U), static_cast<uint8_t>(val >> 24U), \
                static_cast<uint8_t>(val >> 32U), static_cast<uint8_t>(val >> 40U), \
                static_cast<uint8_t>(val >> 48U), static_cast<uint8_t>(val >> 56U)  \
    }

#define PTR_TO_UINT16(arr) (uint16_t)((arr)[0U] | (uint16_t) (arr)[1U] << 8U)
#define PTR_TO_UINT24(arr) \
    (uint32_t)(uint32_t)(arr)[0U] | (uint32_t) (arr)[1U] << 8U | (uint32_t) (arr)[2U] << 16U;
#define PTR_TO_UINT32(arr)                                                                     \
    (uint32_t)(uint32_t)(arr)[0U] | (uint32_t) (arr)[1U] << 8U | (uint32_t) (arr)[2U] << 16U | \
            (uint32_t) (arr)[3U] << 24U;
#define PTR_TO_UINT40(arr)                                                                     \
    (uint32_t)(uint64_t)(arr)[0U] | (uint64_t) (arr)[1U] << 8U | (uint64_t) (arr)[2U] << 16U | \
            (uint64_t) (arr)[3U] << 24U | (uint64_t) (arr)[4U] << 32U;
...
#define PTR_TO_UINT56(arr)                                                                     \
    (uint32_t)(uint64_t)(arr)[0U] | (uint64_t) (arr)[1U] << 8U | (uint64_t) (arr)[2U] << 16U | \
            (uint64_t) (arr)[3U] << 24U | (uint64_t) (arr)[4U] << 32U |                        \
            (uint64_t) (arr)[5U] << 40U | (uint64_t) (arr)[6U] << 48U;
