...
void ServiceCommunication::SendMessage ( Core::Event event ) const
{
    ...
    switch (event.id) {
        case Cluster::EClusters::GENERAL: {
            Cluster::General::ClusterGeneral *clusterGeneral = (Cluster::General::ClusterGeneral *) this->mClusters.GetCluster(
        ...
        case Cluster::EClusters::PROXIMITY: {
            Cluster::Proximity::ClusterProximity *clusterProximity = (Cluster::Proximity::ClusterProximity *) this->mClusters.GetCluster(
        ...
        case Cluster::EClusters::BATTERY: {
            Cluster::Battery::ClusterBattery *clusterBattery = (Cluster::Battery::ClusterBattery *) this->mClusters.GetCluster(
