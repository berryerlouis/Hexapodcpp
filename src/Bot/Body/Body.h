...
namespace Bot
{
    namespace Body
    {
        ...
        public:
            ...
            virtual void
            UpdateWalkStatus(const Move::Walk::EWalkStatus status,
            ...
            virtual bool
            SetDirection(const float directionAngle) final override;
            ...
            virtual bool
            SetGait(const Move::Gait::GaitType gait) final override;
