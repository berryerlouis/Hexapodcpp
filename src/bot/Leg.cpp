...
Leg::Leg(ELeg legId, Servo&coxa, Servo&femur, Servo&tibia)
...
void Leg::SetLegIk (const Leg::Position3d&position, const Leg::Position3d&bodyIk, const uint16_t travelTime) {
	...
	this->mLegIk.coxaFootDist = sqrt(this->mLegIk.newFootPos.x * this->mLegIk.newFootPos.x + this->mLegIk.newFootPos.y * this->mLegIk.newFootPos.y);
	this->mLegIk.iksw         = sqrt(((this->mLegIk.coxaFootDist - COXA_LENGTH) * (this->mLegIk.coxaFootDist - COXA_LENGTH)) + (this->mLegIk.newFootPos.z * this->mLegIk.newFootPos.z));
	this->mLegIk.ika1         = atan((this->mLegIk.coxaFootDist - COXA_LENGTH) / this->mLegIk.newFootPos.z);
	this->mLegIk.ika2         = acos(((TIBIA_LENGTH * TIBIA_LENGTH) - (FEMUR_LENGTH * FEMUR_LENGTH) - (this->mLegIk.iksw * this->mLegIk.iksw)) / (-2 * this->mLegIk.iksw * FEMUR_LENGTH));
	this->mLegIk.tangle       = acos(((this->mLegIk.iksw * this->mLegIk.iksw) - (TIBIA_LENGTH * TIBIA_LENGTH) - (FEMUR_LENGTH * FEMUR_LENGTH)) / (-2 * FEMUR_LENGTH * TIBIA_LENGTH));
	...
	this->mCoxa.SetAngle((uint8_t)this->mLegIk.coxaIk, travelTime);               //+150
