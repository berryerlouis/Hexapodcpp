...
namespace Cluster
{
    namespace Imu
    {
        ...
        public:
            ...
            static Core::Status BuildFrameAll(const Vector3 &acc, const Vector3 &gyr, const Vector3 &mag,
            ...
            static Core::Status BuildFrameCalibMag(const bool min, const Vector3F &calib, Frame &response);
