...
namespace Cluster
{
    namespace Body
    {
        ...
        public:
            ...
            static Core::Status  BuildFrameUpdateAmplitude(Frame        &response,
                                                           const uint8_t successAmplitude);

            static Core::Status  BuildFrameUpdateElevation(Frame        &response,
                                                           const uint8_t successElevation);
            ...
            static Core::Status  BuildFrameUpdateDuration(Frame         &response,
                                                          const uint16_t duration);

            Core::Status         BuildFrameUpdateGait(Frame               &response,
