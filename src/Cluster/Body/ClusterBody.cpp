...
namespace Cluster
{
    namespace Body
    {
        ...
        Core::Status ClusterBody::BuildFrameSetBodyPosition(Frame         &response,
            ...
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::SET_BODY_POS_ROT);
        ...
        Core::Status ClusterBody::BuildFrameSetLegPosition(Frame         &response,
                                                           const uint32_t successMove) {
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::SET_LEG_POS_ROT);
            if (success == Core::Status::CORE_OK) {
                response.Set4BytesParam(successMove);
            }
            return success;
        ...
        Core::Status ClusterBody::BuildFrameUpdateDirection(Frame         &response,
            ...
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::GET_DIRECTION);
            if (success == Core::Status::CORE_OK) {
        ...
        Core::Status ClusterBody::BuildFrameUpdateRotation(Frame         &response,
            ...
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::GET_ROTATION);
            if (success == Core::Status::CORE_OK) {
        ...
        Core::Status ClusterBody::BuildFrameUpdateAmplitude(Frame        &response,
            ...
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::GET_AMPLITUDE);
            if (success == Core::Status::CORE_OK) {
        ...
        Core::Status ClusterBody::BuildFrameUpdateElevation(Frame        &response,
            ...
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::GET_ELEVATION);
            if (success == Core::Status::CORE_OK) {
        ...
        Core::Status ClusterBody::BuildFrameUpdateAll(Frame         &response,
            ...
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::GET_ALL_PARAMS);
            if (success == Core::Status::CORE_OK) {
                response.Set1ByteParam(amplitude);
                response.Set1ByteParam(elevation);
                response.Set2BytesParam(direction);
        ...
        Core::Status ClusterBody::BuildFrameUpdateDuration(Frame         &response,
                                                           const uint16_t duration) {
            const Core::Status success = response.Build(EClusters::BODY, EBodyCommands::GET_DURATION);
            if (success == Core::Status::CORE_OK) {
                response.Set2BytesParam(duration);
            }
            return success;
