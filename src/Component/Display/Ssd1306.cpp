...
void Ssd1306::DrawChar ( char c, uint16_t x, uint16_t y, Bitmap::Bitmaps::Color color )
{
    ...
    for ( j = 0U; j < CHARACTER_WIDTH; j++ )
    {
        for ( i = 0U; i < CHARACTER_HEIGHT; i++ )
        {
            ...
            {
                Ssd1306::DrawPixel( x + j, y + i, color == Bitmap::Bitmaps::Color::COLOR_BLACK ? Bitmap::Bitmaps::Color::COLOR_WHITE : Bitmap::Bitmaps::Color::COLOR_BLACK );
            }
        }
    }
    this->mNeedToUpdate = true;
...
void Ssd1306::DrawBitmap ( const Bitmap::Bitmaps::SBitmap *bmp, uint16_t x, uint16_t y, Bitmap::Bitmaps::Color color )
{
#ifndef GTEST
