...
namespace Component
{
    namespace Imu
    {
        ...
        void Ahrs::GetRollPitchYaw(Imu3d &ypr) const {
            ypr.yaw = atan2(2.0F * (this->mQuaternion[1] * this->mQuaternion[2] +
            ...
            ypr.pitch = -asin(2.0F * (this->mQuaternion[1] * this->mQuaternion[3] -
                                      this->mQuaternion[0] * this->mQuaternion[2]));
            ypr.roll = atan2(2.0F * (this->mQuaternion[0] * this->mQuaternion[1] +
        ...
        void Ahrs::Update(Vector3F acc, Vector3F gyr, Vector3F mag, const float deltaTime) {
            ...
            hx = mag.x * q1q1 - _2q1my * q4 + _2q1mz * q3 + mag.x * q2q2 + _2q2 * mag.y * q3 +
                 _2q2 * mag.z * q4 - mag.x * q3q3 - mag.x * q4q4;
            hy = _2q1mx * q4 + mag.y * q1q1 - _2q1mz * q2 + _2q2mx * q3 - mag.y * q2q2 +
                 mag.y * q3q3 + _2q3 * mag.z * q4 - mag.y * q4q4;
            _2bx = sqrt(hx * hx + hy * hy);
            _2bz = -_2q1mx * q3 + _2q1my * q2 + mag.z * q1q1 + _2q2mx * q4 - mag.z * q2q2 +
            ...
            s3 = -_2q1 * (2.0F * q2q4 - _2q1q3 - acc.x) + _2q4 * (2.0F * q1q2 + _2q3q4 - acc.y) -
                 ...
                 (-_4bx * q3 - _2bz * q1) *
                         (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mag.x) +
