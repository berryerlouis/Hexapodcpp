...
namespace Component
{
    namespace Imu
    {
        ...
        void Ahrs::GetRollPitchYaw(Imu3d &ypr) const {
            ypr.yaw =
                    atan2(2.0F * (this->mQuaternion[1] * this->mQuaternion[2] +
                                  this->mQuaternion[0] * this->mQuaternion[3]),
                          this->mQuaternion[0] * this->mQuaternion[0] +
                                  this->mQuaternion[1] * this->mQuaternion[1] -
                                  this->mQuaternion[2] * this->mQuaternion[2] -
                                  this->mQuaternion[3] * this->mQuaternion[3]);
            ypr.pitch =
                    -asin(2.0F * (this->mQuaternion[1] * this->mQuaternion[3] -
                                  this->mQuaternion[0] * this->mQuaternion[2]));
            ypr.roll =
                    atan2(2.0F * (this->mQuaternion[0] * this->mQuaternion[1] +
                                  this->mQuaternion[2] * this->mQuaternion[3]),
                          this->mQuaternion[0] * this->mQuaternion[0] -
                                  this->mQuaternion[1] * this->mQuaternion[1] -
                                  this->mQuaternion[2] * this->mQuaternion[2] +
                                  this->mQuaternion[3] * this->mQuaternion[3]);
            ...
            // 2° 47' E  ± 0° 22 Declination Chirens
        ...
        void Ahrs::Update(Vector3F    acc,
            ...
            hx = mag.x * q1q1 - _2q1my * q4 + _2q1mz * q3 + mag.x * q2q2 +
                 _2q2 * mag.y * q3 + _2q2 * mag.z * q4 - mag.x * q3q3 -
                 mag.x * q4q4;
            hy = _2q1mx * q4 + mag.y * q1q1 - _2q1mz * q2 + _2q2mx * q3 -
                 mag.y * q2q2 + mag.y * q3q3 + _2q3 * mag.z * q4 - mag.y * q4q4;
            _2bx = sqrt(hx * hx + hy * hy);
            _2bz = -_2q1mx * q3 + _2q1my * q2 + mag.z * q1q1 + _2q2mx * q4 -
                   mag.z * q2q2 + _2q3 * mag.y * q4 - mag.z * q3q3 +
                   mag.z * q4q4;
            _4bx = 2.0F * _2bx;
            _4bz = 2.0F * _2bz;

            // Gradient decent algorithm corrective step
            s1 = -_2q3 * (2.0F * q2q4 - _2q1q3 - acc.x) +
                 _2q2 * (2.0F * q1q2 + _2q3q4 - acc.y) -
                 _2bz * q3 *
                         (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) -
                          mag.x) +
                 (-_2bx * q4 + _2bz * q2) *
                         (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - mag.y) +
                 _2bx * q3 *
                         (_2bx * (q1q3 + q2q4) + _2bz * (0.5f - q2q2 - q3q3) -
                          mag.z);
            s2 = _2q4 * (2.0F * q2q4 - _2q1q3 - acc.x) +
                 _2q1 * (2.0F * q1q2 + _2q3q4 - acc.y) -
                 ...
                 (_2bx * q4 - _4bz * q2) *
                         (_2bx * (q1q3 + q2q4) + _2bz * (0.5f - q2q2 - q3q3) -
                          mag.z);
            s3 = -_2q1 * (2.0F * q2q4 - _2q1q3 - acc.x) +
                 _2q4 * (2.0F * q1q2 + _2q3q4 - acc.y) -
                 ...
                 (_2bx * q1 - _4bz * q3) *
                         (_2bx * (q1q3 + q2q4) + _2bz * (0.5f - q2q2 - q3q3) -
                          mag.z);
            s4 = _2q2 * (2.0F * q2q4 - _2q1q3 - acc.x) +
                 _2q3 * (2.0F * q1q2 + _2q3q4 - acc.y) +
            ...
            qDot1 = 0.5f * (-q2 * gyr.x - q3 * gyr.y - q4 * gyr.z) -
                    this->mBeta * s1;
            qDot2 = 0.5f * (q1 * gyr.x + q3 * gyr.z - q4 * gyr.y) -
                    this->mBeta * s2;
            qDot3 = 0.5f * (q1 * gyr.y - q2 * gyr.z + q4 * gyr.x) -
                    this->mBeta * s3;
            qDot4 = 0.5f * (q1 * gyr.z + q2 * gyr.y - q3 * gyr.x) -
                    this->mBeta * s4;
