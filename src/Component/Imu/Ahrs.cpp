    ...
    namespace Imu
    {
        ...
        void Ahrs::GetRollPitchYaw(Imu3d &ypr) const {
            ypr.yaw = atan2(
                    ...
                    this->mQuaternion[0] * this->mQuaternion[0] + this->mQuaternion[1] * this->mQuaternion[1] -
                            this->mQuaternion[2] * this->mQuaternion[2] - this->mQuaternion[3] * this->mQuaternion[3]);
            ypr.pitch = -asin(
        ...
        void Ahrs::Update(Vector3F    acc,
            ...
            hx = mag.x * q1q1 - _2q1my * q4 + _2q1mz * q3 + mag.x * q2q2 + _2q2 * mag.y * q3 + _2q2 * mag.z * q4 -
                 mag.x * q3q3 - mag.x * q4q4;
            hy = _2q1mx * q4 + mag.y * q1q1 - _2q1mz * q2 + _2q2mx * q3 - mag.y * q2q2 + mag.y * q3q3 +
                 _2q3 * mag.z * q4 - mag.y * q4q4;
            _2bx = sqrt(hx * hx + hy * hy);
            _2bz = -_2q1mx * q3 + _2q1my * q2 + mag.z * q1q1 + _2q2mx * q4 - mag.z * q2q2 + _2q3 * mag.y * q4 -
                   mag.z * q3q3 + mag.z * q4q4;
            _4bx = 2.0F * _2bx;
            _4bz = 2.0F * _2bz;
