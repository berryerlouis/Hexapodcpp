...
#define NB_SAMPLES_MAG 1000U
        ...
        void Mpu9150::UpdateCalibration(const SensorsImu sensor) {
            ...
            if (++this->mIndexCalib ==
                (this->mSensorToCalib == MAG ? NB_SAMPLES_MAG : NB_SAMPLES_ACC_GYR)) {
        ...
        void Mpu9150::UpdateAll() {
            ...
            if (this->mI2c.ReadRegisters(this->mAddress,
                ...
                this->mTmp =
                        static_cast<uint8_t>((((data[6U] << 8U) | ((data[7U]))) / 340.0F) + 36.5F);
            }
        }
        ...
        Vector3 Mpu9150::UpdateAcc() {
            ...
            if (this->mI2c.ReadRegisters(this->mAddress,
                                         ...
                                         6U)) {
                accRaw.x =
                        ((accRaw.x & 0x00FF) << 8U | ((accRaw.x & 0xFF00U) >> 8U)) - mAccOffset.x;
                accRaw.y =
                        ((accRaw.y & 0x00FF) << 8U | ((accRaw.y & 0xFF00U) >> 8U)) - mAccOffset.y;
                accRaw.z =
                        ((accRaw.z & 0x00FF) << 8U | ((accRaw.z & 0xFF00U) >> 8U)) - mAccOffset.z;
            }
        ...
        Vector3 Mpu9150::UpdateGyr() {
            ...
            if (this->mI2c.ReadRegisters(this->mAddress,
                                         ...
                                         6U)) {
                gyrRaw.x =
                        ((gyrRaw.x & 0x00FF) << 8U | ((gyrRaw.x & 0xFF00U) >> 8U)) - mGyrOffset.x;
                gyrRaw.y =
                        ((gyrRaw.y & 0x00FF) << 8U | ((gyrRaw.y & 0xFF00U) >> 8U)) - mGyrOffset.y;
                gyrRaw.z =
                        ((gyrRaw.z & 0x00FF) << 8U | ((gyrRaw.z & 0xFF00U) >> 8U)) - mGyrOffset.z;
            }
        ...
        Vector3 Mpu9150::UpdateMag() {
            ...
            if (dataIsReady == 1U && this->mI2c.ReadRegisters(this->mAddressMag,
                                                              ERegisterMag::XOUT_L,
                ...
                if (!this->mStartCalib) {
                    this->mMag.x =
                            ((magRaw.x - this->mMagOffset.x) * res * this->mMagBias.x) * magSign.x;
                    this->mMag.y =
                            ((magRaw.y - this->mMagOffset.y) * res * this->mMagBias.y) * magSign.y;
                    this->mMag.z =
                            ((magRaw.z - this->mMagOffset.z) * res * this->mMagBias.z) * magSign.z;
                } else {
