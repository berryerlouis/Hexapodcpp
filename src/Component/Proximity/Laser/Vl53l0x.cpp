...
#define RANGE_SEQUENCE_STEP_FINAL_RANGE (0x80)
            ...
            Vl53l0x::Vl53l0x(Twi::TwiInterface &i2c, Led::LedInterface &led, const uint8_t address)
                : mI2c(i2c)
                , mLed(led)
                , mAddress(address)
                , mDistance(0)
            ...
            Core::Status Vl53l0x::Initialize() {
                ...
                if (data == 0xEEU) {
                    this->mI2c.ReadRegister(
                            this->mAddress, VL53L0X_VHV_CONFIG_PAD_SCL_SDA_EXTSUP_HV, data);
                    this->mI2c.WriteRegister(
                            this->mAddress, VL53L0X_VHV_CONFIG_PAD_SCL_SDA_EXTSUP_HV, data | 0x01);
                    ...
                    this->mI2c.WriteRegister(
                            this->mAddress, VL53L0X_SYSTEM_INTERRUPT_CONFIG_GPIO, 0x04);
                    this->mI2c.ReadRegister(this->mAddress, VL53L0X_GPIO_HV_MUX_ACTIVE_HIGH, data);
                    this->mI2c.WriteRegister(
                            this->mAddress, VL53L0X_GPIO_HV_MUX_ACTIVE_HIGH, data & ~0x10);
            ...
            uint16_t Vl53l0x::GetDistance() {
                ...
                do {
                    ...
                    timeout++;
                } while (static_cast<bool>(sysrange_start & 0x01) && timeout < 100U);
                ...
                do {
                    this->mI2c.ReadRegister(
                            this->mAddress, VL53L0X_RESULT_INTERRUPT_STATUS, interrupt_status);
                    timeout++;
            ...
            bool Vl53l0x::PerformSingleRefCalibration(const calibration_type_t calib) const {
                ...
                this->mI2c.WriteRegister(
                        this->mAddress, VL53L0X_SYSTEM_SEQUENCE_CONFIG, sequence_config);
            ...
            bool Vl53l0x::ReadRegister16Bits(const uint8_t reg, uint16_t &data) {
                uint8_t buffer[2U];
