...
#define RANGE_SEQUENCE_STEP_FINAL_RANGE (0x80)
                ...
                if (data == 0xEEU) {
                    ...
                    if (this->PerformSingleRefCalibration(CALIBRATION_TYPE_VHV)) {
                        if (this->PerformSingleRefCalibration(CALIBRATION_TYPE_PHASE)) {
                            this->mI2c.WriteRegister(this->mAddress, VL53L0X_SYSTEM_SEQUENCE_CONFIG,
            ...
            bool Vl53l0x::WriteRegister16Bits(const uint8_t reg, const uint16_t &data) {
                uint8_t buffer[2U];
            ...
            bool Vl53l0x::WriteRegister32Bits(const uint8_t reg, const uint32_t &data) {
                uint8_t buffer[4U];
